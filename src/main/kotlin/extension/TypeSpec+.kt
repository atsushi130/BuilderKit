...
internal fun TypeSpec.Builder.definePrimaryConstructor(classInformation: ClassInformation): TypeSpec.Builder {
    ...
    return this.primaryConstructor(FunSpec.constructorBuilder().addParameters(parameters).build()).addProperties(properties)
}
...
internal fun TypeSpec.Builder.defineBuildFunction(classInformation: ClassInformation): TypeSpec.Builder {
    ...
    val function = FunSpec.builder("build")
                          .addStatement("return ${classInformation.className}(${classInformation.properties.buildModelArguments()})")
                          .build()
